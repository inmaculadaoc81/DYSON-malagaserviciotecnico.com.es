...
fallbackToggle.className = 'dypoint-chat-fallback';
fallbackToggle.setAttribute('aria-label', 'Abrir chatbot DyPoint');
...
if (target && !target.dataset.dypointChatInitialized) {
  target.dataset.dypointChatInitialized = 'true';
